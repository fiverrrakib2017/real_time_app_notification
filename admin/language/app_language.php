<?php
	...
	// for invalid otp
	$app_lang['invalid_otp']="OTP is invalid !";
    ...
    // for lagin success
	$app_lang['otp_success']="Your OTP verification is successfully.";
	...
	$app_lang['otp_sent_mail']="OTP has been sent on your mail.";	

	// for added success
	$app_lang['add_success']="Added successfully.";
	
	// for added success
	$app_lang['suggest_success']="Suggest successfully.";
	...
	// for email your otp label
	$app_lang['your_otp_lbl']="Your OTP is";
...
// for otp email subject
	$app_lang['forgot_otp_sub_lbl']="[IMPORTANT] ### OTP Information";  // don't remove ### that will be replaced by you app name
